...
<img src="../media/states.png" width="500">
...
<img src="../media/flat_constraints.png" width="500">
...
| Board Angle | Board Angular Velocity | Direction of Pump |
| --- | --- | --- |
| - | + | Down |
| + | + | Up |
| + | - | Down |
...
The top part of the following figure shows the "Down" position and the bottom part shows the "Up" position:

<img src="../media/pumping_control.jpg" width="500">

There is a delay of 0.1 seconds in the change of direction in order to reduce noise.

### Manual

Manual control seeks to maintain the overall center of mass of the robot directly above the back wheel of the skateboard, using LQR control. It requires the dynamics to be linearized around the equilibrium point  of `G` = `Q`, as well as an initial velocity and x.

<img src="../media/manual_control.jpg" width="500">
