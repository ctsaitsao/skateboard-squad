...
function [G_jac] = derivative_conservative_forces_3DOF(x_3DOF,params)
...
bottomLinkTheta = x_3DOF(2);
bottomLinkHeight = params.bottomLinkHeight;
g = params.g;
topLinkRCoM = params.topLinkYCoM;
topLinkMass = params.topLinkMass;
topLinkTheta = x_3DOF(3);

G_jac = autogen_derivative_conservative_forces_3DOF(boardMass,boardTheta,boardHeight,boardLength,bottomLinkRCoM,bottomLinkMass,bottomLinkTheta,bottomLinkHeight,g,topLinkRCoM,topLinkMass,topLinkTheta);
